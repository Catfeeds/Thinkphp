...
function formatAdminPage(&$page){
    ...
    $page->setConfig('theme',"<ul class='pagination pagination-xs m-top-none pull-right'><li>%FIRST%</li><li>%UP_PAGE%</li><li>%LINK_PAGE%</li><li>%DOWN_PAGE%</li><li>%END%</li><li><a> %NOW_PAGE%/%TOTAL_PAGE% 页</a></li></ul>");
}
// 构建后台分页
